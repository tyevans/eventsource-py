...
class TestOTELMetricsAvailable:
    ...
    def test_otel_metrics_available_is_boolean(self):
        ...
        from eventsource.application.migration.metrics import OTEL_METRICS_AVAILABLE
...
class TestNoOpInstruments:
    ...
    def test_noop_counter_add_does_nothing(self):
        ...
        from eventsource.application.migration.metrics import NoOpCounter
    ...
    def test_noop_histogram_record_does_nothing(self):
        ...
        from eventsource.application.migration.metrics import NoOpHistogram
    ...
    def test_noop_gauge_init_does_nothing(self):
        ...
        from eventsource.application.migration.metrics import NoOpGauge
...
class TestMigrationMetricSnapshot:
    ...
    def test_snapshot_default_values(self):
        ...
        from eventsource.application.migration.metrics import MigrationMetricSnapshot
...
class TestActiveMigrationsTracker:
    ...
    def test_singleton_pattern(self):
        ...
        from eventsource.application.migration.metrics import ActiveMigrationsTracker
...
class TestPhaseTimer:
    ...
    def test_timer_not_started(self):
        ...
        from eventsource.application.migration.metrics import _PhaseTimer
...
class TestCutoverTimer:
    ...
    def test_timer_not_started(self):
        """Timer returns 0 when not started."""
        from eventsource.application.migration.metrics import _CutoverTimer
