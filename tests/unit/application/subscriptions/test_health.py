...
from eventsource.application.subscriptions.subscription import Subscription, SubscriptionState
...
class TestManagerHealth:
    ...
    def test_create_manager_health(self):
        ...
        from eventsource.application.subscriptions.health import ManagerHealth, SubscriptionHealth
...
class TestSubscriptionHealth:
    ...
    def test_create_subscription_health(self):
        ...
        from eventsource.application.subscriptions.health import SubscriptionHealth
...
class TestReadinessStatus:
    ...
    def test_create_ready_status(self):
        ...
        from eventsource.application.subscriptions.health import ReadinessStatus
...
class TestLivenessStatus:
    ...
    def test_create_alive_status(self):
        ...
        from eventsource.application.subscriptions.health import LivenessStatus
