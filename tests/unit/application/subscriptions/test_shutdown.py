...
class TestModuleImports:
    ...
    def test_shutdown_reason_exported(self):
        ...
        from eventsource.application.subscriptions.shutdown import __all__
...
class TestMetricsModuleImports:
    ...
    def test_import_metrics_snapshot(self):
        ...
        from eventsource.application.subscriptions.shutdown import ShutdownMetricsSnapshot
...
class TestPreShutdownHookImports:
    ...
    def test_import_pre_shutdown_hook_type(self):
        ...
        from eventsource.application.subscriptions.shutdown import PreShutdownHook
...
class TestPostShutdownHookImports:
    ...
    def test_import_post_shutdown_hook_type(self):
        ...
        from eventsource.application.subscriptions.shutdown import PostShutdownHook
