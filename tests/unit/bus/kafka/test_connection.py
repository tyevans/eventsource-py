...
from eventsource.bus.kafka.connection import (  # noqa: E402
    KafkaConnectionManager,
    KafkaRebalanceListener,
)
from eventsource.bus.kafka.metrics import KafkaEventBusMetrics  # noqa: E402
...
class TestConnect:
    ...
    async def test_connect_starts_producer_and_consumer(self) -> None:
        ...
        with (
            patch(
                "eventsource.bus.kafka.connection.AIOKafkaProducer",
                return_value=mock_producer,
            ),
            patch(
                "eventsource.bus.kafka.connection.AIOKafkaConsumer",
