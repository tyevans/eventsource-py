...
from eventsource.bus.kafka.bus import KafkaEventBus  # noqa: E402
...
async def test_connect_wires_metrics_after_connection_established(
    ...
    where the facade actually references them: eventsource.bus.kafka.bus.
    """
    bus = bus_with_mocks
    ...
    monkeypatch.setattr("eventsource.bus.kafka.bus.register_connection_gauge", mock_register_conn)
    monkeypatch.setattr("eventsource.bus.kafka.bus.register_consumer_lag_gauge", mock_register_lag)
