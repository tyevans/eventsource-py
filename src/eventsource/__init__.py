...
_LAZY: dict[str, str] = {
    ...
    "tenant_context": "eventsource.multitenancy",
    "TenantContextToken": "eventsource.multitenancy",
    "get_current_tenant": "eventsource.multitenancy",
    "get_required_tenant": "eventsource.multitenancy",
    "set_current_tenant": "eventsource.multitenancy",
    "reset_tenant_context": "eventsource.multitenancy",
    "clear_tenant_context": "eventsource.multitenancy",
    "tenant_scope": "eventsource.multitenancy",
    "tenant_scope_sync": "eventsource.multitenancy",
    "TenantDomainEvent": "eventsource.multitenancy",
    "TenantContextNotSetError": "eventsource.multitenancy",
    "TenantContextResetError": "eventsource.multitenancy",
    "TenantMismatchError": "eventsource.multitenancy",
