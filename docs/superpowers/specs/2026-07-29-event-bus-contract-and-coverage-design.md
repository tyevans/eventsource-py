...
| [0013 - Handler Registry and Adapter as Collaborators](../../adrs/0013-handler-registry-composition.md) | Stands | `HandlerAdapter` is explicitly unchanged by this work (see "Unchanged" above); the composition-over-inheritance shape it documents is exactly the shape `BaseEventBus` follows for bus-level concerns. |
