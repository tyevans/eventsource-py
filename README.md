...
- [Installation Guide](docs/installation.md) - Detailed installation with optional dependencies
- [Getting Started Guide](docs/getting-started.md) - Build your first event-sourced application
